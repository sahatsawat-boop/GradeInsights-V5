// Global Error Handler
    ...
    function handleGradebookFilterChange() {
      ...
      if (filteredData.length === 0) {
        body.innerHTML = `<tr><td colspan="${11 + scoreHeaders.length}" style="text-align: center; color: var(--text-muted); padding: 30px;">ไม่มีนักเรียนที่ตรงกับตัวเลือกการกรองข้อมูล</td></tr>`;
        return;
      }
    ...
    function updatePrintPreviewContent() {
      ...
      const totalCols = 3 + scoreHeaders.length + 4; 
